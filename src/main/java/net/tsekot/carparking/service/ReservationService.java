...
public class ReservationService {
    ...
    @Autowired
    public ReservationService(EntityManagerFactory entityManagerFactory) {
    ...
    public String reserveSpot(String userId, String spotId, String startTime) {
        ...
        if (spot.getAvailable()) {
            ...
            entityManager.persist(Reservation.buildReservation(reservationId, userId, spotId, startTime, startTime, "22.0"));
